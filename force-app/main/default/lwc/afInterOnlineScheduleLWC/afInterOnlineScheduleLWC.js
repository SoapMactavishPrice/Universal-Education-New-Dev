...
import getOnlineContactName from '@salesforce/apex/CalledForInteractionOnlineController_LWC.getOnlineContactName';
...
import createOnlineEvent from '@salesforce/apex/CalledForInteractionOnlineController_LWC.createOnlineEvent';
...
export default class CalledForInteractionOnlineReschedule_LWC extends NavigationMixin(LightningElement) {
    ...
    fetchContactName() { 
        getOnlineContactName({ AdmissioFormId: this.recordId })
            .then(result => {
                ...
                if (result.interactionSchedule) {
                    this.showToast('Error', 'Interaction Online is already scheduled', 'error');
                    this.interactionSchedule = result.interactionSchedule;
