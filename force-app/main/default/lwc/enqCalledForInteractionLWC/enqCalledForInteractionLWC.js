...
import getEnquiryName from '@salesforce/apex/enqInteractionController_LWC.getEnquiryName';
...
import calledForInteraction from '@salesforce/apex/enqInteractionController_LWC.calledForInteraction';
        ...
        getEnquiryName({ enquiryId: this.recordId })
            .then(result => {
                ...
                if (result.SchoolTourScheduled) {
                    this.showToast('Error', 'Called for an Interaction is scheduled.', 'error');
